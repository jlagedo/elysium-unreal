...
| `items/ground_models.json`, `hud/use_icons.json`, `ui/strings.json`, `sound/usable/soundgroups.json` | Small immutable lookup manifests are parsed independently by their owning runtime systems | **Confirmed** |
