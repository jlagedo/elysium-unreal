...
3. **Divergence needs an owner's call.** The project owner approves each behavioural
   divergence explicitly, and it lands in `roadmap.md`'s decision log, dated, with the
...
| Every behavioural divergence | `roadmap.md` decision log, dated, owner-approved |
