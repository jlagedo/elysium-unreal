...
Referenced GLB units are defined by `docs/contracts/seam_map_animation_bank.md`,
`docs/contracts/seam_map_material.md`, `docs/contracts/seam_map_texture.md`, and
`docs/contracts/seam_map_surface_property.md`.
