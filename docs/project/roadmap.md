...
- [~] **[13.4 Computer terminals & tutorial hacking](plans/terminals.md)** — the parser,
  ...
  (2026-09-07); the cues, the keyboard screen and the HUD hint landed (2026-09-07); email landed
  (2026-09-07); open: the modern cell painter and material, the diagnostic, and the gym beat
