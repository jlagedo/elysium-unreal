...
- [~] **[13.4 Computer terminals & tutorial hacking](plans/terminals.md)** — the parser,
  ...
  (2026-09-07); the cues, the keyboard screen and the HUD hint landed (2026-09-07); open: email, the
  modern cell painter and material, the diagnostic, and the gym beat script. Gamepad is out of scope by owner call.
