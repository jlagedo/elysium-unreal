...
- [~] **[13.4 Computer terminals & tutorial hacking](plans/terminals.md)** — the parser,
  ...
  (2026-09-07); the cues, the keyboard screen and the HUD hint landed (2026-09-07); email, the cell painter, the diagnostic and the native gym beat landed (2026-09-07); open: the
  authored screen material and font settings (editor), the Play-tier shot baselines and beat
  script (11.10), and the remaining loader caps. Gamepad is out of scope by owner call.
