...
patch's own maps). docs/vtmb/entity_io.md tables are based on the patch set; the retail
default is the labelled comparison baseline.

Findings and the use_icon enum are written up in docs/vtmb/entity_io.md.
"""
...
DEFAULT_MAPS = os.path.join(install.GAME, "maps")
