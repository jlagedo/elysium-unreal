...
namespace
{
	...
	const FRow GInventory[] = {
		...
		{ TEXT("cam_restore"),  EK::Once,       EG::Camera,   EB::None,         TEXT("the patch's KP_5 alias for snapto") },
		{ TEXT("cam_rotateleft"),  EK::Once,    EG::Camera,   EB::None,         TEXT("step cam_yaw -15 degrees (patch alias)") },
		{ TEXT("cam_rotateright"), EK::Once,    EG::Camera,   EB::None,         TEXT("step cam_yaw +15 degrees (patch alias)") },
