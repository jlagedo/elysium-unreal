...
namespace
{
	...
	// `controls.md` § "What is bindable" in declaration order. A verb with no implementation names
	...
	const FRow GInventory[] = {
		...
		{ TEXT("centerview"),   EK::Once,       EG::Movement, EB::None,         TEXT("recentre pitch -- 11.7") },
		{ TEXT("force_centerview"), EK::Once,   EG::Movement, EB::None,         TEXT("recentre pitch, unconditional -- 11.7") },
		...
		// --- Camera -----------------------------------------------------------------------
		{ TEXT("togglecamera"), EK::Once,       EG::Camera,   EB::None,         TEXT("first/third person -- 11.7") },
		{ TEXT("thirdperson"),  EK::Once,       EG::Camera,   EB::None,         TEXT("third person -- 11.7") },
		{ TEXT("firstperson"),  EK::Once,       EG::Camera,   EB::None,         TEXT("first person -- 11.7") },
		{ TEXT("camortho"),     EK::Once,       EG::Camera,   EB::None,         TEXT("orthographic camera -- 11.7") },
		{ TEXT("snapto"),       EK::Once,       EG::Camera,   EB::None,         TEXT("snap the camera to its ideal -- 11.7") },
		{ TEXT("cam_command"),  EK::Once,       EG::Camera,   EB::None,         TEXT("camera control channel -- 11.7") },
		{ TEXT("camin"),        EK::ButtonPair, EG::Camera,   EB::CamIn,        TEXT("dolly in -- 11.7") },
		{ TEXT("camout"),       EK::ButtonPair, EG::Camera,   EB::CamOut,       TEXT("dolly out -- 11.7") },
		{ TEXT("campitchup"),   EK::ButtonPair, EG::Camera,   EB::CamPitchUp,   TEXT("orbit up -- 11.7") },
		{ TEXT("campitchdown"), EK::ButtonPair, EG::Camera,   EB::CamPitchDown, TEXT("orbit down -- 11.7") },
		{ TEXT("camyawleft"),   EK::ButtonPair, EG::Camera,   EB::CamYawLeft,   TEXT("orbit left -- 11.7") },
		{ TEXT("camyawright"),  EK::ButtonPair, EG::Camera,   EB::CamYawRight,  TEXT("orbit right -- 11.7") },
		{ TEXT("cammousemove"), EK::ButtonPair, EG::Camera,   EB::CamMouseMove, TEXT("mouse-driven orbit -- 11.7") },
		{ TEXT("camdistance"),  EK::ButtonPair, EG::Camera,   EB::CamDistance,  TEXT("mouse-driven dolly -- 11.7") },
		{ TEXT("commandermousemove"), EK::ButtonPair, EG::Camera, EB::CommanderMouseMove, TEXT("commander-mode mouse camera -- 11.7") },
