"""Generate the local, game-agnostic Audio Mixer routing assets.

Loose VtMB media stays under $ELYSIUM_EXPORT_ROOT and is never imported. These assets contain policy only:
