...
class LaneRecord:
    ...
    #: The engine copy this lane builds against. UnrealBuildTool's single-instance mutex is
    #: keyed on its own assembly path, so two checkouts sharing one engine root serialize
    #: their builds against each other. Absent in records written before per-lane engines.
