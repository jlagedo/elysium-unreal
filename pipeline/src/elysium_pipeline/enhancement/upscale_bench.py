...
def main():
    ...
    ap.add_argument("--models", default=os.fspath(cache_root() / "models"),
                    help="folder of .pth/.safetensors models")
    ap.add_argument("--out", default=os.fspath(export_root() / "_enhancement" / "bench"),
                    help="output folder")
