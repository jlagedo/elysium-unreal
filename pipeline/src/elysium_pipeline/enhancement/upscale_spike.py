...
from elysium_pipeline.enhancement.upscale_bench import Model, merge_rgba, split_rgba
from elysium_pipeline.paths import cache_root, export_root


DEFAULT_MODEL = cache_root() / "models" / "4x-PBRify_UpscalerV4.pth"
DEFAULT_OUT = export_root() / "_upscale_spike"
...
class Sample:
    ...
    def source(self) -> Path:
        return export_root() / self.map_name / self.relative_path
