...
Usage:
    ...
    python tools/validate_skeletal_pipeline.py --report tools/out/_tests/skeletal_pipeline.json
"""
...
NPC_DIR = Path(__file__).resolve().parent / "out" / "npc"
...
def main() -> int:
    ...
    if not args.manifest.is_file():
        raise SystemExit(f"missing NPC manifest: {args.manifest}; run tools/npc_export.py")
