# Source's distance fog, as a per-primitive material term (docs/sky-ambience.md B8b).
#
...
# Keep in sync with FOG_CPD_* in tools/bake_map.py and ElysiumFog.h in the runtime.
...
def specular(mat, inv_f, x, y, source=None):
    ...
    (docs/reflections.md). Omitted, it is UE's own 0.5 default, which is what a surface with
