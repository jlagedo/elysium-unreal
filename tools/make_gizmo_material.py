...
# these are authored here once and committed; the runtime only instances them.
#
# Normally rebuilt by the umbrella (content.bat -> tools/build_content.py, which the export runs);
# also runnable standalone:
#   UnrealEditor-Cmd.exe ElysiumUE.uproject -run=pythonscript -script="tools/make_gizmo_material.py" -unattended -nosplash -nopause
import unreal
