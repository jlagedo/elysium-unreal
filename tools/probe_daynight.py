...
`styles[8]` @48, `day[8]` @56, `night[8]` @64 (docs/sky-ambience.md, tools/CLAUDE.md).
...
Usage:
    python tools/probe_daynight.py              # every map in the install (108)
    python tools/probe_daynight.py sp_tutorial_1 sm_hub_1
    python tools/probe_daynight.py --verbose    # per-map lines, not just the rollup
"""
import collections
import re
import struct
