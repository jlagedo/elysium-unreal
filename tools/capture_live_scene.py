...
import install
from capture_live_pose import find_module, find_process


ROOT = Path(__file__).resolve().parent
OUTPUT_ROOT = ROOT / "out" / "_live_pose"
...
def build_if_needed() -> None:
    ...
    sources = [
        ...
        ROOT / "live_pose_capture" / "live_pose_hook.cpp",
        ROOT / "live_pose_capture" / "live_pose_injector.cpp",
    ]
