...
Usage:
    python tools/probe_scenes.py                    # rollup over every .vcd
    python tools/probe_scenes.py --markdown         # the doc tables
    python tools/probe_scenes.py --dump <path>      # pretty-print one parsed scene
    python tools/probe_scenes.py --referenced       # only map-referenced scenes
    python tools/probe_scenes.py --json <path>      # write the full survey

Findings are written up in ../docs/choreographed_scenes.md (roadmap RE19).
